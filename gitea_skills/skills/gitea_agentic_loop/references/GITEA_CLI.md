# Gitea Agentic Development Loop Reference

This reference document provides CLI commands for managing the local AI-driven development workflow.
...
- **Never merge PRs**: Do NOT run the `gitea-skills merge` command. The user must be the one to manually merge PRs unless explicitly instructed otherwise.
